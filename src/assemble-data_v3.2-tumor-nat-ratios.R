...
setwd('c:/Users/karsten/Dropbox/Devel/CPTAC-LUAD2020/')

## import gct files
data.dir <- 'g:/Shared drives/CPTAC3.0_LUAD_Data/luad-v3.2-data-freeze/'
label <- 'v3.2-tumor-over-nat'

ord.column <- 'NMF.consensus'


gct.str <- c(glue("{data.dir}luad-v3.2-acetylome-ratio-norm-NArm.gct"),
             glue("{data.dir}luad-v3.2-cnv-gene-LR.gct"),
             glue("{data.dir}luad-v3.2-phosphoproteome-ratio-norm-NArm.gct"),
             glue("{data.dir}luad-v3.2-proteome-ratio-norm-NArm.gct"),
             glue("{data.dir}luad-v3.2-rnaseq-prot-uq-rpkm-log2-NArm-row-norm.gct")
             )
...
## fix smoking status
cdesc$Smoking.Score.WGS <- as.numeric(cdesc$Smoking.Score.WGS)
